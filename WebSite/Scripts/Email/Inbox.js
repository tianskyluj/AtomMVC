...
$(function () {
    ...
    $("#inboxTable tbody").on('click', 'tr', function (e) {                  // 修改表格名称
    ...
    /* Init the table */
    oTable = $('#inboxTable').dataTable({                                    // 修改表格名称
        "sDom": "<'row-fluid'<'span6'l><'span6'f>r>t<'row-fluid'<'span6'i><'span6'p>>",
        "sPaginationType": "bootstrap",
        "oLanguage": {
            "sProcessing": "处理中...",
    ...
    $('#inboxTable .toggle-checkboxes').click(function () {              // 修改表格名称
        var $checkbox = $("#inboxTable").find('.checkbox');              // 修改表格名称
        if ($(this).is(':checked')) {
    ...
    $('#inboxTable .checkbox').click(function () {                       // 修改表格名称
    ...
    $('.reply').click(function () {
        var url = "/Email/NewEmail/" + $(this).attr("value");
        redirect(url);
    });
    // 分页后加载方法
